 ...
 <h1 style="margin-top: 0; text-align: center;"> Drug Discovery with Python
...
The course content is aimed at undergraduate students but it is expected that users have grasped some fundamental Python skills. The content aims to build on the the <a href="https://github.com/Edinburgh-Chemistry-Teaching/Data-driven-chemistry">Data-Driven Chemistry</a> course prepared by the University of Edinburgh’s School of Chemistry while focusing on Drug Discovery.
